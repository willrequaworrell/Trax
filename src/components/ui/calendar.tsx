  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        button_previous:
          "absolute left-0 inline-flex size-8 items-center justify-center rounded-lg border border-border/70 bg-background text-muted-foreground transition hover:text-foreground",
        button_next:
          "absolute right-0 inline-flex size-8 items-center justify-center rounded-lg border border-border/70 bg-background text-muted-foreground transition hover:text-foreground",
        ...
        day_button:
          "inline-flex size-9 items-center justify-center rounded-lg text-sm transition hover:bg-muted focus-visible:border-ring focus-visible:ring-2 focus-visible:ring-ring/30 focus-visible:outline-none",
